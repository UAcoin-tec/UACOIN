    ...
    model(0)
{
    ...
    ui->addressIn_SM->setPlaceholderText(tr("Enter a uacoin address (e.g. mhN8btKtp3HrXgZJwyBakUzALLZ34nA4J)"));
    ...
    ui->signatureIn_VM->setPlaceholderText(tr("Enter uacoin signature"));
#endif
