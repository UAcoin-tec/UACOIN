...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case MAX: return QString("uacoin");
    case mMAX: return QString("muacoin");
    case uMAX: return QString::fromUtf8("μuacoin");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case MAX: return QString("uacoins");
    case mMAX: return QString("Milli-uacoins (1 / 1,000)");
    case uMAX: return QString("Micro-uacoins (1 / 1,000,000)");
    default: return QString("???");
    }
}
