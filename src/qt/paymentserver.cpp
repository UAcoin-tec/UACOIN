...
const QString BITCOIN_IPC_PREFIX("uacoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click uacoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start uacoin: click-to-pay handler");
    else
...
{
    // clicking on uacoin: URLs creates FileOpen events on the Mac:
