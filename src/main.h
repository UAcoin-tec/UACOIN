...
static const unsigned int MAX_BLOCK_SIZE = 2000000;                                 // set MAX_BLOCK_SIZE as 2,000,000
/** Obsolete: maximum size for mined blocks */
static const unsigned int MAX_BLOCK_SIZE_GEN = MAX_BLOCK_SIZE / 2;
/** Default for -blockmaxsize, maximum size for mined blocks **/
//static const unsigned int DEFAULT_BLOCK_MAX_SIZE = 350000;
static const unsigned int DEFAULT_BLOCK_MAX_SIZE = MAX_BLOCK_SIZE - 1000;           // set DEFAULT_BLOCK_MAX_SIZE as MAX_BLOCK_SIZE - 1000
/** Default for -blockmintxfee, which sets the minimum feerate for a transaction in blocks created by mining code add by keonlee in 20180322 **/
...
static const int64 MAX_MONEY = 5000000000 * COIN; // ~24.05233920 billion
...
public:
    ...
    IMPLEMENT_SERIALIZE
    (
        // unsigned int vinsize = 0;
        READWRITE(this->nVersion);
        //if(fGetSize)    std::cout << "[uacoin] GetSerializeSize() : nVersion : " << nSerSize << "(nSerSize), " << std::endl;
        nVersion = this->nVersion;
        READWRITE(vin);
        // if(fGetSize)    
        // {
        //     vinsize = nSerSize - 4;
        //     std::cout << "[uacoin] GetSerializeSize() : vin : " << vinsize << "(vinsize), " << std::endl;
        //     std::cout << "[uacoin] GetSerializeSize() : vin : " << vin.ToString() << std::endl;
        // }
        READWRITE(vout);
        // if(fGetSize)
        // {
        //     std::cout << "[uacoin] GetSerializeSize() : vout : " << nSerSize - vinsize << "(voutsize), " << std::endl;
        //     std::cout << "[uacoin] GetSerializeSize() : vin : " << vout.ToString() << std::endl;
        // }
        READWRITE(nLockTime);
        // if(fGetSize)    std::cout << "[uacoin] GetSerializeSize() : size : " << nSerSize << "(nSerSize), " << std::endl;        
    )
