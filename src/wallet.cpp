                                ...
                                CWalletTx& wtxNew, CReserveKey& reservekey, int64& nFeeRet, std::string& strFailReason)
{
...

    {
        LOCK2(cs_main, cs_wallet);
        {
            ...
            // std::cout << "[uacoin] CWallet::CreateTransaction() : " << nFeeRet << "(nFeeRet) = (nTransactionFee)" << std::endl;
            ...
            while(true)
            {
                ...
                if (nFeeRet < CTransaction::nMinTxFee && nChange > 0 && nChange < CENT)
                {
                    ...
                    // std::cout << "[uacoin] CWallet::CreateTransaction() : " << nFeeRet << "(nFeeRet) = " << nFeeRet - nMoveToFee << "(nFeeRet) + " << nMoveToFee << "(nMoveToFee)" << std::endl;
                }
                ...
                if (nChange > 0)
                {
                    ...
                    // change transaction isn't always pay-to-uacoin-address
                    ...
                    {
                        nFeeRet += nChange;
                        // std::cout << "[uacoin] CWallet::CreateTransaction() : " << nFeeRet << "(nFeeRet) = " << nFeeRet - nChange << "(nFeeRet) + " << nChange << "(nChange)" << std::endl;
                ...
                // std::cout << "[uacoin] CWallet::CreateTransaction() : Get in GetMinFee() " 
                //         << nPayFee << "(nPayFee), " 
                //         << nTransactionFee << "(nTransactionFee), " 
                //         << nBytes << "(nBytes), " 
                //         << dPriority << "(dPriority)"
                //         << fAllowFree << "(fAllowFree)"
                //         << std::endl;
                
                int64 nMinFee = wtxNew.GetMinFee(1, fAllowFree, GMF_SEND);
                
                // std::cout << "[uacoin] CWallet::CreateTransaction() : Get out GetMinFee() " 
                //         << nFeeRet << "(nFeeRet), " 
                //         << nPayFee << "(nPayFee), " 
                //         << nMinFee << "(nMinFee)" 
                //         << std::endl << std::endl;
...
string CWallet::SendMoney(CScript scriptPubKey, int64 nValue, CWalletTx& wtxNew, bool fAskFee)
{
    ...
    //std::cout << "[uacoin] CWallet::SendMoney() : Entry " << std::endl;
    ...
    //std::cout << "[uacoin] CWallet::SendMoney() : End " << std::endl;
