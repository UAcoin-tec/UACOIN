...
---------------------
	...
	cd src/
	make -f makefile.unix		# Headless uacoin

See readme-qt.rst for instructions on building uacoin-Qt, the graphical user interface.
...
---------------------
 ...
 libcrypto++ Cryptography      Provides implementations for cryptography in uacoin
...
A complete list of dependencies, that can usually be installed via apt-get, is:
	...
	git-core build-essential libssl-dev libboost-all-dev libgtk2.0-dev libminiupnpc-dev qt4-qmake mingw32 synaptic qt-sdk qt4-dev-tools libqt4-dev libqt4-core libqt4-gui libdb++-dev


Notes
-----
The release is built with GCC and then `strip uacoind` to strip the debug
...
Security
--------
To help make your uacoin installation more secure by making certain attacks impossible to
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, uacoin should be built with a non-executable stack
