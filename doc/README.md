...
Intro
---------------------
uacoin is a free open source peer-to-peer electronic cash system that is
...
Setup
---------------------
You need the Qt4 run-time libraries to run uacoin-Qt. On Debian or Ubuntu:
	`sudo apt-get install libqtgui4`

Unpack the files into a directory and run:

- bin/32/uacoin-qt (GUI, 32-bit)
- bin/32/uacoind (headless, 32-bit)
- bin/64/uacoin-qt (GUI, 64-bit)
- bin/64/uacoind (headless, 64-bit)
